SET DEFINE OFF;
Prompt drop Package BOA_FEES_VALIDATE;

Prompt Package BOA_FEES_VALIDATE;
--
-- BOA_FEES_VALIDATE  (Package) 
--
...
Prompt Package Body BOA_FEES_VALIDATE;
--
-- BOA_FEES_VALIDATE  (Package Body) 
--
